---
{
  "id": "C011",
  "type": "claim",
  "title": "Delayed AI access can outperform always-on access on an immediate independent test",
  "statement": "In one controlled but non-randomized laboratory study, a policy that delayed or withheld GenAI access produced better immediate unassisted content-test performance and metacognitive accuracy than always-on access, without outperforming a no-access condition.",
  "status": "provisional",
  "confidence": "low",
