---
{
  "id": "C012",
  "type": "claim",
  "title": "Minimal AI training and access did not improve authentic bedside performance",
  "statement": "In one registered multicentre trial, allowing final-year medical students to use GPT-4o during real patient encounters after brief training did not improve blinded clinical-assessment performance relative to no digital aids.",
  "status": "provisional",
  "confidence": "moderate",
