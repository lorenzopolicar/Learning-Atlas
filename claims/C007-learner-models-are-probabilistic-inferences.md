---
{
  "id": "C007",
  "type": "claim",
  "title": "Learner models are probabilistic inferences, not ground truth",
  "statement": "A learner-model estimate is an inference from fallible observations under construct and model assumptions, so it should carry provenance, uncertainty, and limits on use.",
  "status": "provisional",
  "confidence": "high",
