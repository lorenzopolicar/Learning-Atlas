...
4. Search primary literature and authoritative repositories. Record exact queries, dates, and result paths for an active review.
5. Inspect the actual source. Admit at most three sources, emphasizing nulls, contradictions, replications, and underrepresented contexts.
6. Create or revise atomic claims. Never promote from snippets or abstracts alone.
7. Write a weekly briefing: signal, evidence change, contradictions, product implication, and next question.
8. Update research state, regenerate derived files, validate, and test.
9. Open a draft pull request. Do not merge it.
...
7. Produce a synthesis briefing and draft pull request; do not self-approve maturity changes.
